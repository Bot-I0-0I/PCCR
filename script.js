...
function render(filter = "") {
    ...
    filtered.forEach((p, index) => {
        ...
        let ratingTier = rating > 500 ? 'LEGEND' : rating > 400 ? 'STAR' : rating > 250 ? 'ELITE' : rating > 100 ? 'PRO': 'ROOKIE';
        let tierColor = rating > 500 ? '#eab308' : rating > 400 ? '#a855f7' : rating > 150 ? '#22d3ee' : '#94a3b8';
